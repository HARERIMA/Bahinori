...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("User login page");
        ...
        buttonForgotPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(LoginActivity.this, "You cane reset password now", Toast.LENGTH_SHORT).show();
        ...
        authProfile.signInWithEmailAndPassword(email, pwd).addOnCompleteListener( LoginActivity.this,new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    ...
                    //Check if email is verified before use can access their profile
...
//Check if user is logged in. In such case, straightaway take the user to the user's profile
